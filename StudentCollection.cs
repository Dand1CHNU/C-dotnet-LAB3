...

{
    internal class StudentCollection
    {
        ...
        public void AddDefaults()
        {
            ...
            _students.Add(new Student(new Person("Ivan", "Avramenko", new DateOnly(2005, 09, 29)), Education.Master, 205) { Exams = new List<Exam>() { new Exam(), new Exam("Programming", 2, new DateOnly(2021, 6, 3)) } });
        }
