...

{
    internal class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            studentCollection.AddStudents(new Student[] { new Student(new Person("Taras", "Bulba", new DateOnly(1999, 10, 23)), Education.SecondEducation, 202) { Exams = new List<Exam>() { new Exam("Php", 4, new DateOnly(2021, 12, 09)), new Exam("C", 5, new DateOnly(2022, 2, 12)) }, Tests = new List<Test>() { new Test(), new Test("Computer graphic", false), new Test("Database", true) } }, new Student(new Person("Igor", "Igorovich", new DateOnly(2005, 09, 29)), Education.Master, 205) { Exams = new List<Exam>() { new Exam(), new Exam("Database", 3, new DateOnly(2020, 6, 1)) }, Tests = new List<Test>() { new Test() } } });
